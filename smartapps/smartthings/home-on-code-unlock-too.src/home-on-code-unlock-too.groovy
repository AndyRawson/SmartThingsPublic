...
//		}
		...
		section("Notifications") {
			...
			if (!hhNotifyOnly) {
				...
				if (phone1) {
					input name: "stSMS", title: "Send SMS notification to:", type: "phone", defaultValue: "${phone1}", required: false
				}
				else {
					input name: "stSMS", title: "Send SMS notification to:", type: "phone", required: false
				}
			}	
		}
