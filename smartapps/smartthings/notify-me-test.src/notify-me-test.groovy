 ...
 *https://graph.api.smartthings.com/ide/app/edit/d2f22560-4d22-44b0-8815-d24f887ef0bb
...
preferences {
	section("Choose one or more, when..."){
        ...
        input "memode", "", title: "Location", required: false, multiple: false
	}
...
def subscribeToEvents() {
    ...
    subscribe(location, logme)
    
}

def logme(evt) {
	log.debug "Location got evt ${evt}"
}
