 ...
 metadata {
	...
	tiles {
		...
		standardTile("alarmMode", "device.alarmMode", inactiveLabel: true, canChangeIcon: false) {
            state "unknown", label: 'Loading...', icon:"st.unknown.unknown.unknown", action:"setAlarmMode", nextState:"unknown"
		...
		standardTile("autoLock", "device.autoLock", inactiveLabel: true, canChangeIcon: false) {
            state "unknown", label: 'Loading...', icon:"st.unknown.unknown.unknown", action:"setAutoLock", nextState:"unknown"
		...
		standardTile("vacationMode", "device.vacationMode", inactiveLabel: true, canChangeIcon: false) {
            state "unknown", label: 'Loading...', icon:"st.unknown.unknown.unknown", action:"setVacationMode", nextState:"unknown"
            state "off", label: 'Vacation', icon:"st.unknown.unknown.unknown", action:"setVacationMode", nextState:"unknown"
            state "on", label: 'Vacation', icon:"st.unknown.unknown.unknown", action:"setVacationMode", backgroundColor:"#79b821", nextState:"unknown"
		}
        
        // not included in details
        
		standardTile("lockLeave", "device.lockLeave", inactiveLabel: true, canChangeIcon: false) {
            state "unknown", label: 'Loading...', icon:"st.unknown.unknown.unknown", action:"setLockLeave", nextState:"unknown"
            state "off", label: 'Vacation', icon:"st.unknown.unknown.unknown", action:"setLockLeave", nextState:"unknown"
            state "on", label: 'Vacation', icon:"st.unknown.unknown.unknown", action:"setLockLeave", backgroundColor:"#79b821", nextState:"unknown"
		}
...
//            zwave.configurationV2.configurationGet(parameterNumber: 0x4),		// vacation mode
//            zwave.configurationV2.configurationGet(parameterNumber: 0x5),		// lock and leave
...
//            zwave.configurationV2.configurationGet(parameterNumber: 0xB),		// local alarm control disable
...
//            zwave.configurationV2.configurationGet(parameterNumber: 0x10),		// user code pin length
