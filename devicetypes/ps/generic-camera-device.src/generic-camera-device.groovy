...
def sendEmail(attachedContent) {
            ...
            def root = builder(key: "RAlw_hn3RNcJNY1vi253vg", 
		              message: [text: '',
            					subject: 'Camera Alert',
            					from_email: 'andy.rawson@gmail.com',
            					from_name: 'RH Workshop',
            					to: [[email: '6184099755@mms.att.net',
                					  name: 'Andy',
    					              type: 'to'
	    							]],      
    ...
    log.debug "Sent email with Mandrill"
}
